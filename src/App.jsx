    ...
    <>
      ...
      <div className="tentang mt-32 py-10" id="tentang">
        ...
        <div className="tools mt-32">
          ...
          <p className="xl:w-2/5 lg:w-2/4 md:w-2/3 sm:w-3/4 w-full text-base/loose opacity-50" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300" data-aos-once="true">Berikut ini beberapa tools yang biasa dipakai</p>
      ...
      <div className="proyek mt-32 py-10" id="proyek">
        ...
        <p className="text-base/loose text-center opacity-50" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300" data-aos-once="true">Berikut ini beberapa proyek yang telah kami buat.</p>
