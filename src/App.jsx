  ...
  return (
    <>
      ...
      <div className="blog mt-32 py-10" id="blog">
        ...
        <p className="text-base/loose text-center opacity-50" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300" data-aos-once="true">Jelajahi Dunia Kami</p>
